...
def main():
    """Main training function for Swin-Tiny"""
    ...
    logger = WandbLogger(
        ...
        tags=['swin', 'tiny', 'transformer', 'plant-pathology']
    )
    print()
    ...
    # STEP 4: Create Model
    # =========================================================================
    print("🤖 STEP 4: Creating Swin-Tiny Model...")
    ...
    print("\n" + "="*80)
    print("✅ SWIN-TINY TRAINING COMPLETED!")
    print("="*80)
